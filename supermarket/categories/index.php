                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <div class="dropdown pull-right">
                            <button class="btn btn-primary" id="dLabel" type="button" data-toggle="modal"
    ...
    <div class="modal fade none-border" id="add_category">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post">
                    <input type="hidden" name="category[company_id]"
                        value="<?php echo $loggedInAdmin->company_id; ?>" />
                    <input type="hidden" name="category[branch_id]" value="<?php echo $loggedInAdmin->branch_id; ?>" />
                    <div class="modal-body row">

                        <div class="col-sm-6">
                            <label>Category Name</label>

                            <input type="text" name="category[category]" placeholder="Category Name"
                                class="form-control">
