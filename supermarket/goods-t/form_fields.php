 <div class="col-lg-12">
   <form  id="form" class="validation" enctype="multipart/form-data" method="post" accept-charset="utf-8">
      ...
      <div class="row">
         <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <input type="text" name="code" value="<?php echo h($product->code); ?>"  class="form-control tip" id="code"  required="required" />
            </div>
            ...
            <div class="form-group">
               ...
               <select name="category" class="form-control select2 tip" id="category"  required="required" style="width:100%;">
                  ...
                  <?php foreach (ProductCategory::find_by_undeleted(['order' => 'ASC']) as $key => $value) { ?>
                      <option value="<?php echo $value->id; ?>" <?php echo $product->category == $value->id ? 'selected' : '';  ?>><?php echo $value->category; ?></option>
                  <?php } ?>
               </select>
            </div>
            ...
            <div class="form-group">
               <label for="price">Selling Price: {Per bottle}</label>                                    
         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
               ...
               <input type="file" class="custom-file-input" value="<?php echo h($product->file); ?>"  name="file[]" multiple id="image">
            </div>

             <div class="form-group">
               <label for="product_tax">Product Tax</label> Percentage without % sign i.e 4 for 4 percent                                    
               ...
               <div class="table-responsive bg-success">
                  ...
                  <table class="table table-bordered">
                     <tr style="font-weight: bold;">
                        <td>Estimate Price {Per bottle}</td>
      ...
      <div class="form-group">
         ...
         <textarea name="details" cols="40" rows="10"  class="form-control tip redactor" id="details" value="<?php echo h($product->details); ?>"><?php echo h($product->details); ?></textarea>
      </div>
      <div class="form-group">
         <input type="submit" name="uploadFile" id="add_product" value="Add Products"  class="btn btn-primary" />
      </div>
   </form>
</div>
