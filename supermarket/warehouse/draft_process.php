                        ...
                        <div class="well well-sm" id="leftdiv">
                           <div id="lefttop" style="margin-bottom:5px;">
                               <div class="input-group">
                                <input readonly class="form-control" type="text" value="<?php echo Table::find_by_id($cc_id)->table_id; ?>"style="width: 100%;" >
                                      <input readonly class="form-control" type="hidden" value="<?php echo $cc_id; ?>" name="customer_id" style="width: 100%;" id="spos_customer">
                                      <div class="input-group-addon no-print" style="padding: 2px 5px;">
                                         <a class="external" ><i class="fa fa-2x fa-plus-circle" id="addIcon"></i></a>
                                      </div>
                                   </div>

                                   <div class="input-group d-none"> 
                                      <select name="customer_id" class="form-control select2 select2-danger " data-dropdown-css-class="select2-danger" data-placeholder="Select Customer" style="width: 100%;position:absolute; display: none;" id="spos_customer">
                                   ...
                                   <div class="col-xs-4 d-none" style="padding: 0;">
                                      <div class="btn-group-vertical btn-block">
                                         ...
                                         <button type="button" class="btn btn-danger btn-block btn-flat"
                                            id="clear_cart" style="height:67px;">Clear</button>
                                      </div>
                                   </div>
                                   ...
                                   <div class="col-xs-4" style="padding: 0;">
                                    <?php if ($action == 0) { ?>
                                      <button type="button" class="btn btn-primary btn-block btn-flat"
                                            id="save_to_draft" style="height:67px;">Update Cart</button>
                                    <?php }else{ ?>
               ...
               <td>
                    ...
                    <div class="contents  p-0 pt-4 " id="">
                       ...
                       <div id="all_items"></div>
                        <?php }else{ ?>
                            <h1 class="bold fs-20 p-0 pt-4">Process Payment...</h1>
                         <?php } ?>
                       <div class="product-nav">
                          <div class="btn-group btn-group-justified">
                             <div class="btn-group">
                                <a style="z-index:10002;" href="<?php echo url_for('sales/debt.php') ?>" class="btn btn-warning pos-tip btn-flat"  id="previou"><i class="fa fa-chevron-left"></i></a>
                             </div>
                             <div class="btn-group">
...
<input type="hidden" id="url" value="<?php echo url_for('/thanks') ?>">
<input type="hidden" id="stock_url" value="<?php echo url_for('/products/stock/index.php') ?>">
<input type="hidden" id="table_url" value="<?php echo url_for('/pos/tables.php') ?>">
...
<div class="pull-right">
  <?php 
    if ($location == 1) {
      $array = DraftDetails::find_by_ref($ref_no);
    }else{
      $array = creditDetails::find_by_ref($ref_no);
    }

    foreach ($array as $key => $value) {?>
   <input type="hidden" name="ref_no[]" value="<?php echo $value->ref_no ?>">
   ...
   <input type="text" name="product_quantity[]" value="<?php echo $value->quantity ?>">
   <input type="hidden" name="product_tax[]" value="0">
   <input type="hidden" name="product_discount[]" value="0">
   <input type="hidden" name="stockUnit[]" value="<?php echo product::find_by_id($value->product_id)->quantity + $value->quantity ?>">
...
<?php //echo pre_r($_SESSION['shopping_cart']); ?>
          ...
          $(document).ready(function () {
            $(document).on('click', '#pay_bill', function() {
               // console.log($('#spos_customer').val())
                  ...
                  $("#payModal").modal('show');
                   $.ajax({
                     url:link_url +"pos/hold/credit_bill.php",
                     method:"POST",
                     data: {
                        process_bill: 1,
                    ...
                    $.ajax({
                      ...
                      success: function(r) {
                         if(r.msg == 'FAIL'){
                            ...
                            // clearCartIt();
                            // clear();
                            window.location.href = table_url+'?ref_no'+'='+ r.ref_no;
                         }
            ...
            //         edata.push({name: 'ref_no', value: eref_no});
            //         // console.log(edata)
            //         $.ajax({
            //           url: 'hold/add_item.php',
            //           method: 'post',
            ...
            function clearCartIt() {
               ...
               $.ajax({
                  ...
                  method:"POST",
                  data:{action:action, ref_no:ref_no, from: 2},
                  success:function()
                  {
                     load_cart_data();
            ...
            function clear(){
               ...
               var ref_no = $("#ref_noe").val();
                  $.ajax({
                     url:"hold/action.php",
                     method:"POST",
                     data:{action:action, ref_no:ref_no},
                     success:function()
                     {
                        load_cart_data();
                        $('#cart-popover').popover('hide');
               ...
               $.ajax({
                  ...
                  success:function(r)
                  {
                     if(r.msg != 'FAIL'){
                        ...
                        // successAlert('Created Succesfully'); 
                        var table_url = $("#table_url").val()
                        var c_url = table_url+'?trans_no'+'='+ r.trans_no;
                           $.ajax({
                              url:link_url +"pos/cart/print_receipt.php",
                              method:"GET",
                              data:{
                                 view_receipt: 1,
                                 trans_no: r.trans_no,
      ...
      <script type="text/javascript">
           ...
           function confirmOrder(title, text){
               // var customer = $('#spos_customer').val();
               var table_url = $("#table_url").val()
            // var stock_url = $("#stock_url").val()
            // var c_url = stock_url+'?id'+'='+ eid+'&store_id'+'='+ store_id;
