 ...
 <div class="content-wrapper">
    <section class="content-header">
       ...
       <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $page_title ?> Suppliers</li>
       </ol>
    </section>
                   ...
                   <div class="table-responsive">
                      <table id="example2" class="table table-bordered table-striped table-hover">
                        <thead class="cf">
                         ...
                         <tbody>
                          <?php $sn = 1; foreach (Supplier::find_by_undeleted() as $value) { 
                          ...
                          <?php  if ($value->id != 1) { ?>
                              ...
                              <td><?php echo $sn++; ?></td>
                              <td class="sorting_1"><?php echo $value->company_name?></td>
                              ...
                              <td class="text-center" style="padding:6px;">
                                <div class="btn-group btn-group-justified" role="group">
                                  <div class="btn-group btn-group-xs" role="group">
                                    <a class="tip btn btn-warning btn-xs" title="Profile" href="<?php echo url_for('suppliers/edit.php?id=' . $value->id) ?>">
                                      <i class="fa fa-edit"></i>
                                    </a>
                                  </div>
                                  <div class="btn-group btn-group-xs" role="group">
                                    <a class="tip btn btn-danger btn-xs" title="Delete User" href="<?php echo url_for('suppliers/delete.php?id=' . $value->id) ?>" onclick="return confirm('You are going to remove this user permanently. Press OK to proceed and Cancel to Go Back')">
