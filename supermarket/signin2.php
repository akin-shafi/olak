            ...
            <div class="d-flex justify-content-center align-items-center p-4">
                ...
                <section>
                    ...
                    <div class="btn-group d-flex justify-content-center mb-2">
                        <a href="signin2.php" class="btn"
                            style="color: #000; font-weight: bold; background: whitesmoke; ">Sales Login</a>
                        <a class="btn" href="signin1.php"
                            style="color: #000; font-weight: bold; border:1px solid whitesmoke; ">Admin Login</a>
                    </div>

                    <div class="coy_title">
                        <div class="p-4 m-4 text-uppercase"
                            style="border: 8px dotted #aaa; font-size: 40px; font-weight: bold;text-shadow: ">
                            <?php echo $company->company_name ?> </div>
