...
include(SHARED_PATH . '/header.php'); ?>
 ...
 <div class="content-wrapper">
    <section class="content-header justify-content-between d-flex">
       <h1><?php echo $page_title?></h1>
       <div><a href="<?php echo url_for('reports/ledger.php') ?>">Go to Ledger</a></div>
       ...
       <div class="row">
          <div class="col-xs-12">
            <div class="box box-primary">
                   ...
                   <h5 class="text-uppercase">Inventory Details</h5>
                      <div class="d-flex justify-content-between pb-3"> 
                          <div class="">
                            ...
                            <a href="<?php echo url_for('stock/exportItemData.php?id='. $id) ?>" class="btn btn-success d-none"><i class="fa fa-file-excel-o"></i> Export as CSV</a>
                          ...
                          <div class="btn-group">   
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#stockModal"><i class="fa fa-plus"></i> Add Stock</button>
                      ...
                      <h3 class="text-center text-uppercase">
                          ...
                          <span id="title1"> (<?php echo $currency .' '.number_format(Product::find_by_id($id)->price, 2); ?>)</span>
                      </h3>
                ...
                <?php else: ?>
                  <div class="box-body">
                    <div class="alert alert-danger">Sorry you are unauthorized to updated stock record please contact</div>
                    <ul type="1">
