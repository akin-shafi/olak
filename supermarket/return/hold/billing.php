...
?>
	...
	?>
		...
		?>
			<form id="trans">
				...
				<table class="">
					<tr>
						...
						<!-- <td><input type="hidden" name="product_name[]" value="<?php //echo $values["product_name"]; 
																																				?>"></td> -->
			...
			<input type="hidden" name="trans[cost_of_item]" id="cost_of_item" value="<?php echo  $total_price; ?>">
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-xs-6">
								<div class="form-group">
									...
									<input name="trans[total_paid]" type="text" id="amount" class="pa form-control kb-pad amount" />
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group gc" style="display: none;">
									...
									<input type="text" id="gift_card_no" class="pa form-control kb-pad gift_card_no gift_card_input" value="" />
					...
					<div class="col-xs-3 text-center d-none">
						...
						<div class="btn-group btn-group-vertical" style="width:100%;">
							<button type="button" class="btn btn-info btn-block quick-cash" id="quick-payable" value="<?php echo $grand_total; ?>">Exact Fee<?php //echo number_format($grand_total,2); 
																																																																							?></button>
							<button type="button" class="btn btn-block btn-warning quick-cash" value="<?php echo $ten_percent; ?>">10%</button>
							<button type="button" class="btn btn-block btn-warning quick-cash" value="<?php echo $twenty_percent; ?>">20%</button>
							<button type="button" class="btn btn-block btn-warning quick-cash" value="<?php echo $thirty_percent; ?>">30%</button>
							<button type="button" class="btn btn-block btn-warning quick-cash" value="<?php echo $fifty_percent; ?>">50%</button>
							<button type="button" class="btn btn-block btn-warning quick-cash" value="<?php echo $seventy_percent; ?>">70%</button>
