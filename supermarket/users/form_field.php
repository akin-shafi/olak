...
<form action="<?php echo $url ?>" method="post" accept-charset="utf-8">
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group">
            ...
            <select name="admin[admin_level]" id="group" data-placeholder="Select Group"
                class="form-control input-tip select2" style="width:100%;">
        ...
        <div class="form-group">
            ...
            <input type="text" name="admin[first_name]" value="<?php echo h($admin->first_name); ?>"
                class="form-control tip" id="first_name" required="required" />
        </div>
        <div class="form-group">
            <label for="last_name">Last Name</label>
            <input type="text" name="admin[last_name]" value="<?php echo h($admin->last_name); ?>"
                class="form-control tip" id="last_name" required="required" />
        </div>
        <div class="form-group">
            <label for="phone">Phone</label>
            <input type="text" name="admin[phone]" value="<?php echo h($admin->phone); ?>" class="form-control tip"
                id="phone" required="required" />
        </div>
        <div class="form-group">
            <label for="gender">Gender</label>
            <select name="admin[gender]" class="form-control tip select2" style="width:100%;" id="gender"
                required="required">
                <option value="" selected="">Select Gender</option>
                <?php foreach (Admin::GENDER as $key => $value) { ?>
                <option value="<?php echo $key; ?>" <?php echo $key == $admin->gender ? 'selected' : '';  ?>>
                    <?php echo $value; ?></option>
                <?php } ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="admin[email]" value="<?php echo h($admin->email); ?>" class="form-control tip"
    ...
    <div class="col-lg-6">
        ...
        <div class="form-group">
            ...
            <input type="text" name="admin[username]" value="<?php echo h($admin->username); ?>"
                class="form-control tip" id="username" required="required" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="password" name="admin[confirm_password]" value="" class="form-control tip"
                id="confirm_password" />
        </div>
        <div class="form-group">
            <label for="status">Status</label>
            <select name="admin[account_status]" id="status" data-placeholder="Select Status"
                class="form-control input-tip select2" style="width:100%;">
                <option value="" selected="selected"></option>
                <?php foreach (Admin::ACCOUNT_STATUS as $key => $value) { ?>
                <option value="<?php echo $key; ?>" <?php echo $key == $admin->account_status ? 'selected' : ''; ?>>
                    <?php echo $value; ?></option>
                <?php } ?>
            </select>
        </div>
        ...
        <div class="form-group">
            <label class="checkbox" for="notify">
                <input type="checkbox" name="admin[notify]" value="1" id="notify" checked="checked" /> Notify User by
                Email</label>
        </div>
        <div class="form-group">
