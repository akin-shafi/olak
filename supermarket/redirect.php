...
<body class="login-page login-page-<?php echo $company->color; ?> rtl rtl-inv">
    <div class="container">
        ...
        <div class="alert alert-danger alert-dismissable text-center"><button type="button" class="close"
                data-dismiss="alert">&times;</button><strong>You are Unauthorized</strong></div>
        <?php } ?>
        <div class="container">
            <div class="row">
                <?php if ($warehouse_mgt == 1){?>
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <a href="<?php echo url_for('warehouse/') ?>"
                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <a href="<?php echo url_for('stock/list') ?>"
                        class="card border d-flex align-items-center justify-content-center">
                        <div>
                            <div class="text-center">
                ...
                <?php if ($ledger_mgt == 1){?>
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <a href="<?php echo url_for('reports/ledger.php') ?>"
                        class="card border d-flex align-items-center justify-content-center">
                        <div>
                            <div class="text-center">
