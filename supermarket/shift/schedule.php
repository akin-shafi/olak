          ...
          <form class="row" id="addForm">
            ...
            <div class="form-group col-sm-6">
              <label class="control-label">Shift Period</label>
                <select class="form-control" name="addRecord[shift_period]">
                <option value="">Select Shift</option>
                <?php foreach (Shift::find_by_undeleted(['order' => 'ASC']) as $key => $value) { ?>
            ...
            <div class="form-group col-sm-6">
              ...
              <select class="form-control" name="addRecord[status]">
                <option value="1">ON</option>
                <option value="0" selected="">OF</option>
              </select>
            </div>
