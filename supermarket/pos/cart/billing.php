...
<?php if(isset($_POST['process_bill'])) { ?>
	<?php if(!empty($_SESSION["shopping_cart"])) { ?>
		...
		<form id="trans">
	        ...
	        <input type="hidden" name="trans[created_by]" value="<?php echo $_POST['loggedInAdmin'] ?>">
			   ...
			   <div class="modal-body">
                  <table class="table table-bordered table-striped">
                     <tr>
                        ...
                        <th style="width:25%;"><span id="net_price"><?php echo number_format($values["product_quantity"] * $values["product_price"], 2) ?></span></th>
                        <th style="width:25%;">Product Tax</th>
                        <th style="width:25%;"><span id="pro_tax"><?php echo number_format($values["product_tax"], 2) ?></span> <span id="pro_tax_method"></span></th>
                     </tr>
                  </table>
                  <input type="hidden" id="row_id" />
                  <input type="hidden" id="item_id" />
                  <input type="text"  id="product_name_y<?php echo $values["product_id"]  ?>" value="<?php echo $values["product_name"]  ?>" />
                  <input type="hidden" id="product_tax<?php echo $values["product_id"]  ?>" value="<?php echo $values["product_tax"]  ?>" />
                  <div class="row">
                     <div class="col-sm-6">
                        <div class="form-group">
                     ...
                     <div class="col-sm-6">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control input-sm kb-pad" id="product_quantity_y<?php echo $values["product_id"] ?>" onClick="this.select();" placeholder="Current Quantity" value="<?php echo $values["product_quantity"]  ?>">
                        </div>
                     </div>
                  </div>
                  <div class="row">
