...
if (is_post_request()) {
  ...
  $args = $_POST['supplier'];
  $supplier->merge_attributes($args);
  $result = $supplier->save();

  if ($result === true) {

    // logfile
    // log_action('Edit supplier', "id: {$supplier->id}, Editted by {$loggedInsupplier->full_name()}", "supplier");

    $session->message('The supplier was updated successfully.');
