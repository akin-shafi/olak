                ...
                <ul class="nav navbar-nav pull-left hidden-xs hidden-sm">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img
                                src="<?php echo url_for('assets/images/english.png') ?>" alt="english"></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo url_for('/') ?>pos/language/arabic">
                                    <img src="<?php echo url_for('assets/images/arabic.png') ?>" class="language-img">
                                    &nbsp;&nbsp;Arabic
                                </a></li>
                            <li><a href="<?php echo url_for('/') ?>pos/language/english">
                                    <img src="<?php echo url_for('assets/images/english.png') ?>" class="language-img">
                                    &nbsp;&nbsp;English</a>
                            </li>
                            <li><a href="<?php echo url_for('/') ?>pos/language/french">
                                    <img src="<?php echo url_for('assets/images/french.png') ?>" class="language-img">
                                    &nbsp;&nbsp;French</a>
                            </li>
                            <li><a href="<?php echo url_for('/') ?>pos/language/indonesian">
                                    <img src="<?php echo url_for('assets/images/indonesian.png') ?>"
                                        class="language-img"> &nbsp;&nbsp;Indonesian</a>
                            </li>
                            <li><a href="<?php echo url_for('/') ?>pos/language/portuguese-brazilian">
                                    <img src="<?php echo url_for('assets/images/portuguese-brazilian.png') ?>"
                                        class="language-img"> &nbsp;&nbsp;Portuguese-brazilian</a></li>
                            <li><a href="<?php echo url_for('/') ?>pos/language/spanish">
                                    <img src="<?php echo url_for('assets/images/spanish.png') ?>" class="language-img">
                                    &nbsp;&nbsp;Spanish</a></li>
                        </ul>
                    </li>
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="#">
                                <select class=" form-control form-control-sm p-0 m-0" id="select_store">
                                    ...
                                    <?php $store_id = $_SESSION['store_id'] ?? 1;
                                    foreach (Store::find_by_undeleted(['order' => 'ASC']) as $key => $value) { ?>
                        ...
                        <li class="hidden-xs hidden-sm"><a href="<?php echo url_for('/settings') ?>"><i
                                    class="fa fa-cogs"></i></a></li>
                        <li class="hidden-xs hidden-sm"><a href="<?php echo url_for('/pos/view_bill') ?>"
                                target="_blank"><i class="fa fa-desktop"></i></a></li>
                        <li class="bg-primary">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo url_for('/uploads/avatars/thumbs/male.png') ?>" class="user-image"
                                    alt="Avatar">
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header">
                                    <img src="<?php echo url_for('/uploads/avatars/male.png') ?>" class="img-circle"
                                        alt="Avatar">
                                    <p>
                                        <?php echo Admin::find_by_id($loggedInAdmin->id)->full_name(); ?><br>
                                        <?php echo Admin::find_by_id($loggedInAdmin->id)->email; ?>
                                        <small>Member since
                                            <?php echo date('D d M, Y h:i:a', strtotime(Admin::find_by_id($loggedInAdmin->id)->created_at)); ?>
                                        </small>
                                    </p>
                                </li>
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo url_for('/users/profile/1') ?>"
                                            class="btn btn-default btn-flat">Profile</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="<?php echo url_for('/logout') ?>"
                                            class="btn btn-default btn-flat sign_out">Sign Out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="mm_welcome">
                        <?php if ($loggedInAdmin->admin_level == 1) { ?>
                            <a href="<?php echo url_for('/dashboard/') ?>"><i class="fa fa-dashboard"></i>
                                <span>Dashboard</span></a>
                        <?php } else { ?>
                            <a href="<?php echo url_for('/dashboard/sales.php') ?>"><i class="fa fa-dashboard"></i>
                                <span>Dashboard</span></a>
                        <?php } ?>
                    </li>
                    <li class="mm_pos">
                    ...
                    <li class="treeview mm_sales">
                        ...
                        <ul class="treeview-menu">
                            <li class="divider"></li>
                            <li id="sales_opened"><a href="<?php echo url_for('/reports/today_sale') ?>"><i
                                        class="fa fa-circle-o"></i> Today's Sales Report</a></li>
                            <?php if (in_array($loggedInAdmin->id, [1, 2, 3])) { ?>
                                <li id="sales_index"><a href="<?php echo url_for('/sales/') ?>"><i
                                            class="fa fa-circle-o"></i> All Sales Report</a></li>
                            <?php } ?>
                            <li id="reports_registers"
                                class="<?php echo $page_title == 'Registers Report' ? 'active' : '' ?>"><a
                                    href="<?php echo url_for('/reports/registers') ?>"><i class="fa fa-circle-o"></i>
                                    Registers Report</a></li>
                            <li class="divider"></li>
                        </ul>
                    </li>
