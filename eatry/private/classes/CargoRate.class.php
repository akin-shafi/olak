...
class CargoRate extends DatabaseObject {

  static protected $table_name = "cargo_rates";
  static protected $db_columns = ['id', 'region_id', 'fixed_charge', 'price_per_kg', 'priority', 'created_at', 'updated_at', 'deleted'];
  ...
  public function __construct($args=[]) {
    ...
    $this->price_per_kg = $args['price_per_kg'] ?? '';
  ...
  static public function get_region_id($state_id){
    ...
    $sql .= "WHERE region_id='" . self::$database->escape_string($state_id) . "'";
  ...
  static public function find_all_state() {
    $sql = "SELECT * FROM " . static::$table_name . " ";
    $sql .= "ORDER BY id ASC ";
