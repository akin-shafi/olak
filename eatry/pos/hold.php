                     ...
                     <form action="pos" id="pos-sale-form" method="post" accept-charset="utf-8">
                        ...
                        <div class="well well-sm " id="leftdiv">
                           <div id="lefttop" style="margin-bottom:5px;">
                              <div class="form-group d-none" style="margin-bottom:5px;">
                                 <div class="input-group">
                                    <select  class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" data-placeholder="Select Customer" style="width: 100%;position:absolute;" id="spos_customer">
...
<input type="hidden" id="pos_url" value="<?php echo url_for('/pos/') ?>">
          ...
          $(document).ready(function () {
            $(document).on('click', '#pay_bill', function() {
               // console.log($('#spos_customer').val())
                  ...
                  $("#payModal").modal('show');
                   $.ajax({
                     url:link_url +"pos/hold/billing.php",
                     method:"POST",
                     data: {
                        process_bill: 1,
                        loggedInAdmin: $('#loggedInAdmin').val(),
                        spos_customer: $('#customer_id').val(),
                        ref_no: ref_no,
                        store_id: estore_id
                     },
                     success:function(r)
                        ...
                        // successAlert('Created Succesfully'); 
                           $.ajax({
                              ...
                              success:function(r)
                              {
                                 ...
                                 //    qrcode();
                                 // }else{
                                 //    successAlert('Transaction Succesful'); 
                                 // }
                              }
                           });
                     }else{
