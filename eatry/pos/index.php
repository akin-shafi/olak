               ...
               $.ajax({
                  ...
                  success:function(r)
                  {
                     if(r.msg != 'FAIL'){
                        ...
                        load_cart_data();
                        fetch();
                        window.open(eUrl +'pos/print_slip.php?trans_no='+ r.trans_no, "_blank"); 
                     }else{
      ...
      <script type="text/javascript">
         ...
         $(document).on('click', '#close_register', function(e){
           ...
           $.ajax({
             ...
             success: function(r) {
               if (r.msg =='OK' ) {
                  window.location.href = print_sale + "?created_by=" + r.created_by + "&from=" + r.from + "&to=" + r.to+ "&location=" + "pos";
               }else{
