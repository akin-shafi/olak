...
<html>
   ...
   <body>
               ...
               <div>
                  ...
                  <table class="table table-striped table-condensed table-bordered" style="font-size: 12px;">
                     ...
                     <tbody>
                        ...
                        ?>
                        <tr>
                           <td><?php echo $sn++ . '.' . Product::find_by_id($value->product_id)->pname; ?></td>
                     ...
                     <tfoot>
                        <tr>
                           ...
                           <th colspan="2"><?php echo number_format($transaction->cost_of_item, 2); ?></th>
                        </tr>
                        <tr>
                           <th class="text-left" colspan="2">Order Tax</th>
                           <th colspan="2"><?php echo number_format($transaction->tax, 2); ?></th>
                        </tr>
                        <tr>
                           <th class="text-left" colspan="2">Grand Total</th>
                           <th colspan="2"><?php echo number_format($transaction->cost_of_item + $transaction->tax, 2); ?></th>
                        </tr>
      ...
      <!-- end -->
<input type="hidden" id="pos_page" value="<?php echo url_for('/pos/') ?>">
<input type="hidden" id="today_sales_page" value="<?php echo url_for('/reports/today_sale/') ?>">
...
<?php if ($where == 'draft') { ?>
  <script type="text/javascript">
    $(document).ready(function() {
         ...
         var pos_page = $("#pos_page").val() ;
         setTimeout(function(){
             window.location.href = pos_page;
         }, 1000);//wait 1 seconds
    });
  </script>
<?php }elseif ($where == 'return'){ ?>
<script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        var today_sales_page = $("#today_sales_page").val() ;
         setTimeout(function(){
             window.location.href = today_sales_page;
         }, 1000);//wait 1 seconds
      });
</script>
<?php }else{ ?>
