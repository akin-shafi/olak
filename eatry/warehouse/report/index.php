                      ...
                      <table id="example2" class="table table-bordered table-striped table-hover">
                        <thead class="cf">
                          <tr class="active">
                                ...
                                <!-- <th class="col-xs-1">Balnc(<?php //echo $currency; ?>)</th> -->
                              ...
                              <td class="action" style="min-width:115px; max-width:115px; text-align:center;">
                                      <li class="dropdown hidden-xs">
                                          ...
                                          <ul class="dropdown-menu ">
                                            <?php if($value->verification_status != 1){ ?>
                                              <li class="verify" data-id="<?php echo $value->trans_no ?>" title="Verify"><a href="#" ><i class="fa fa-check"></i>Verify</a>
                                                </li>
                                              <?php } ?>
                                              ...
                                              <?php if($value->balance != 0){ ?>
                                                <li class="add_payment" data-id="<?php echo $value->trans_no ?>" title="Add Payment">
                                                  <a href="#" ><i class="fa fa-plus"></i>Add Payment</a>
                                                </li>
                                              <?php } ?>
                                              
                                              <li class="view_payments" data-id="<?php echo $value->trans_no ?>" title="View Payment">
                                                <a href="#" ><i class="fa fa-money"></i>View Payment</a>
                                              </li>
                                              <li class="edit_sale" data-id="" title="Edit Sale">
                                              <a href="<?php echo url_for('/sales/edit.php?id='.$value->trans_no); ?>" >
                                                  <i class="fa fa-edit"></i>Edit Sales</a>
                                                </li>
                                              <!-- <li class="delete_sale" data-id="<?php //echo $value->id ?>" onclick="return confirm('You are going to delete sale, please click ok to delete.')" title="Delete Sale"><a href="#" >
...
<script type="text/javascript" charset="UTF-8">
  ...
  //     $.ajax({
  //        url: eUrl +"pos/cart/print_receipt.php",
  //        method:"GET",
  //        data:{
  //         view_receipt: 1, 
  //         trans_no: trans_no,
