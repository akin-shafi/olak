             ...
             <div class="box box-primary">
                <div class="box-header">
                   <div class="dropdown pull-right">
                      <a href="<?php echo url_for('products/exportData2.php') ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export as CSV</a>
                ...
                <div class="box-body">
                   <div class="table-responsive">
                      <table id="example2" class="table table-striped table-bordered table-hover" style="margin-bottom:5px;">
                         ...
                         <tbody>
                          <?php $sn = 1; foreach (Product::find_by_undeleted() as $key => $value) {?>
                            <tr>
                              <td><?php echo $sn++; ?> </td>
                              <td><div style="width:32px; margin: 0 auto;"><a href="<?php echo !empty($value->file) ? url_for('/uploads/thumbs/' . $value->file) :  url_for('/uploads/thumbs/bottles.jpg'); ?>" class="open-image">
                                <img src="<?php echo !empty($value->file) ? url_for('/uploads/thumbs/' . $value->file) :  url_for('/uploads/thumbs/bottles.jpg'); ?>" alt="images" class="img-responsive"></a></div></td>
                              ...
                              <td><div class="text-center"><div class="btn-group">
                                ...
                                <a title="View" class="tip btn btn-primary btn-xs view"  data-id="<?php echo $value->id; ?>"><i class="fa fa-file-text-o"></i></a> 

                                

                                <a title="Print Labels" class="tip btn btn-default btn-xs label" data-id="<?php echo $value->id; ?>"><i class="fa fa-print"></i></a>

                                <a href="#" title="Print Barcodes" class="tip btn btn-default btn-xs barcode"  data-id="<?php echo $value->id; ?>"><i class="fa fa-print"></i></a>  <a href="<?php echo url_for('/products/edit.php?id=') ?><?php echo $value->id; ?>" title="Edit Product" class="tip btn btn-warning btn-xs edit" data-id="<?php echo $value->id; ?>"><i class="fa fa-edit"></i></a> <a title="Delete Product" class="tip btn btn-danger btn-xs delete" data-id="<?php echo $value->id; ?>"><i class="fa fa-trash-o"></i></a></div></td>
