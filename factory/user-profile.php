...
<!-- Mirrored from bootstrap.gallery/wafi-admin/dashboard-v2/topbar/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Mar 2022 05:52:53 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
		...
		<!-- Title -->
		<title>Wafi Admin Template - User Profile</title>
	...
	<body>
		...
		<header class="header">
			<div class="logo-wrapper">
				<a href="index.html" class="logo">
					<img src="png/logo.png" alt="Wafi Admin Dashboard" />
				</a>
								...
								<li>
									<a href="#">
										<div class="user-img away">
											<img src="png/user21.png" alt="User" />
										</div>
										<div class="details">
								...
								<li>
									<a href="#">
										<div class="user-img busy">
											<img src="png/user10.png" alt="User" />
										</div>
										<div class="details">
								...
								<li>
									<a href="#">
										<div class="user-img online">
											<img src="png/user6.png" alt="User" />
										</div>
										<div class="details">
							...
							<div class="header-profile-actions">
								<div class="header-user-profile">
									<div class="header-user">
										<img src="png/user.png" alt="Admin Template" />
									</div>
									<h5>Zyan Ferris</h5>
									<p>Admin</p>
								</div>
			...
			<nav class="navbar navbar-expand-lg custom-navbar">
				...
				<div class="collapse navbar-collapse" id="WafiAdminNavbar">
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown">
							<a class="nav-link active-page dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<i class="icon-book-open nav-icon"></i>
								Pages
							</a>
							<ul class="dropdown-menu" aria-labelledby="pagesDropdown">
								<li>
									<a class="dropdown-item active-page" href="user-profile.html">User Profile</a>
								</li>
								<li>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="user-details h-320">
								<div class="user-thumb">
									<img src="png/user24.png" alt="Admin Template" />
								</div>
								<h4>MH Zyan Ferris</h4>
								<h6>UX Designer</h6>
								<p>Canada</p>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="skillset-container h-320">
								...
								<div class="categories">
									...
									<span class="badge badge-primary">Android Development</span>
									<span class="badge badge-primary">Bootstrap 4</span>
									<span class="badge badge-primary">jQuery</span>
									<span class="badge badge-primary">Javascript</span>
									<span class="badge badge-primary">Angular JS</span>
									<span class="badge badge-primary">Python</span>
									<span class="badge badge-primary">React</span>
									<span class="badge badge-primary">Admin Templates</span>
										...
										<table class="table projects-table">
											...
											<tbody>												
												<tr>
													<td>
														<div class="project-details">
															<img src="png/user6.png" class="avatar" alt="Wafi Admin">
												...
												<tr>
													<td>
														<div class="project-details">
															<img src="png/user2.png" class="avatar" alt="Wafi Admin">
															<div class="project-info">
												...
												<tr>
													<td>
														<div class="project-details">
															<img src="png/user4.png" class="avatar" alt="Wafi Admin">
															<div class="project-info">
																<p>Ichiro Suzuki</p>
		...
		************* -->
		...
		<script src="js/basic-radial-graph2.js"></script>
