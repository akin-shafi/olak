				...
				<table class="table table-bordered table-sm">
					...
					<tbody id="phase-table">
						<tr class="border-0">
							...
							<td>
								<input type="text" required name="transfer[]" class="form-control form-control-sm transfer actions">
							</td>
							<td>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(document).on('click', '#add_row', function() {
			...
			html_code += '<td><select class="form-control form-control-sm category_id" name="category_id[]" required><option value="">Select</option><?php foreach ($categories as $cat) { ?><option value="<?php echo $cat->id; ?>"><?php echo ucwords($cat->name); ?></option><?php } ?></select></td>';

			html_code += '<td><select class="form-control form-control-sm product_id" name="product_id[]" required><option value="">Select</option><?php foreach ($products as $pro) { ?><option value="<?php echo $pro->id; ?>"><?php echo ucwords($pro->name); ?></option><?php } ?></select></td>';

			html_code += '<td><select class="form-control form-control-sm gauge_id" name="gauge_id[]" required><option value="">Select</option><?php foreach ($gauges as $gauge) { ?><option value="<?php echo $gauge->id; ?>"><?php echo number_format($gauge->value, 2); ?></option><?php } ?></select></td>';
			...
			html_code += '<td><input type="text" required name="transfer[]" class="form-control form-control-sm transfer actions"></td>'
