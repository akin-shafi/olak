...
$phaseOne = MaterialPhaseOne::find_by_undeleted();
...
<div class="content-wrapper">
  ...
  <ul class="nav nav-tabs" id="phaseTab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link text-uppercase active" id="phase-one-tab" data-toggle="tab" data-target="#phase-one" type="button" role="tab" aria-controls="phase-one" aria-selected="true">Phase One</button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link text-uppercase" id="phase-two-tab" data-toggle="tab" data-target="#phase-two" type="button" role="tab" aria-controls="phase-two" aria-selected="false">Phase Two</button>
    </li>
  </ul>

  <div class="tab-content">
    <div class="tab-pane active" id="phase-one" role="tabpanel" aria-labelledby="phase-one-tab">
                  ...
                  <table class="table custom-table table-sm dataTable">
                    ...
                    <tbody>
                      ...
                      foreach ($phaseOne as $data) :
                        ...
                        $type = MaterialPhaseOne::TYPE[$data->type];
                        $group = MaterialGroup::find_by_id($data->raw_group_id)->name;
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo ucwords($group . ' coil')  ?></td>
                          ...
                          <td>
                            <div class="btn-group">
                              <a href="<?php echo url_for('materials/edit_phase_one.php?id=' . $data->id); ?>" class="btn btn-warning edit-btn">
    ...
    <div class="tab-pane" id="phase-two" role="tabpanel" aria-labelledby="phase-two-tab">
      <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
