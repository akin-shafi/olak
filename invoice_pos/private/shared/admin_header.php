      ...
      <div class="collapse navbar-collapse" id="retailAdminNavbar">
        <ul class="navbar-nav m-auto">
          ...
          <li class="nav-item dropdown d-none">
            ...
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="adminDrop">
              <li>
                <a class="dropdown-item <?php echo ($page_title == "Load Fund") ? 'active' : '' ?>" href="<?php echo url_for('/fund_register/index.php') ?>">Add fund</a>
              </li>
              <li class="">
                <a class="dropdown-item <?php echo ($page_title == "Fund History") ? 'active' : '' ?>" href="<?php echo url_for('/fund_register/index.php') ?>">History</a>
              </li>
        ...
        <li class="nav-item">
          <a class="nav-link  <?php echo ($page_title == "Expenses") ? 'active-page' : '' ?>" href="<?php echo url_for('/expenses/') ?>" id="adminDrop">
          ...
          <?php if ($accessControl->wallet_mgt == 1) : ?>
            ...
            <li class="nav-item dropdown ">
              ...
              <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="adminDrop">
                <?php if (!in_array($loggedInAdmin->admin_level, [2,3])) { ?>
                <li class="">
                  <a class="dropdown-item <?php echo ($page_title == "Wallet") ? 'active' : '' ?>" href="<?php echo url_for('/wallet/index.php') ?>"> Customer's Wallet</a>
                </li>
                <?php } ?>
                <li class="">
                  <a class="dropdown-item <?php echo ($page_title == "Proof of Payments") ? 'active' : '' ?>" href="<?php echo url_for('/wallet/history.php') ?>">Proof of Payments</a>
                </li>
