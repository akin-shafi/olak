<div class="row">
  ...
  <div class="form-group col-md-4">
    ...
    <select name="wallet[company_id]" class="form-control " data-placeholder="Company Name" required>
  ...
  <div class="form-group col-md-4">
    ...
    <select name="wallet[branch_id]" class="form-control " data-placeholder="Branch Name" required>
  ...
  <div class="form-group col-md-4">
    ...
    <select class="form-control" id="bank_name" name="wallet[bank_name]">
