              ...
              <div class="table-responsive">
                ...
                <section class="row">
                  <div class="form-group col-lg-3 col-md-3">
                    ...
                    <div class="btn-group">
                      <select required class="form-control this_client_id select2" name="billing[client_id]" id="client">
...
<script>
  $(document).ready(function() {
    ...
    function submit_form(form_data) {
      ...
      $("#create_request").html("processing..");
    ...
    $(document).on('change', '.this_client_id', function() {
      var cus_id = $(this).val();
