    ...
    <div class="row gutters">
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="daterange-container">
          ...
          <a href="<?php echo url_for('agent/index.php') ?>" data-toggle="tooltip" data-placement="top" title="view all agents" class="download-reports" data-original-title="iew all agents">
                ...
                <div class="row">
                  <div class="col-md-5 col-sm-12 col-12">
                    <div class="profile-info-left">
                      <h3 class="user-name m-t-0"><?php echo $agent->full_name() ?></h3>
                      <h5 class="company-role m-t-0 mb-0">Agent</h5>
                      <div class="staff-id"><i>Registered By : <?php echo Admin::find_by_id($agent->created_by)->full_name(); ?></i></div>
                  ...
                  <div class="col-md-7 col-sm-12 col-12">
                    <ul class="personal-info">
                      <li>
                        ...
                        <span class="text"><a href=""><?php echo $agent->phone; ?></a></span>
                      </li>
                      <li>
                        <span class="title">Email:</span>
                        <span class="text"><a href=""><?php echo $agent->email; ?></a></span>
                      </li>
                      <li>
