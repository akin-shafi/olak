...
?>
<?php $page = "Product"; $page_title = 'All Products'; ?>
                  ...
                  <table id="rowSelection" class="table table-sm table-striped ">
                   ...
                   <tbody>
                    <?php $sn = 1; foreach (Product::find_by_undeleted() as $key => $value) {?>
                      <tr>
                        <td><?php echo $sn++; ?> </td>
                        <td><div style="width:32px; margin: 0 auto;"><a href="<?php echo !empty($value->file) ? url_for('/uploads/thumbs/' . $value->file) :  url_for('/uploads/thumbs/image.jpg'); ?>" class="open-image">
                          <img width="32" src="<?php echo !empty($value->file) ? url_for('/uploads/thumbs/' . $value->file) :  url_for('/uploads/thumbs/bottles.jpg'); ?>" alt="images" class="img-responsive"></a></div></td>
                        ...
                        <td><div class="text-center"><div class="btn-group">
                          ...
                          <a title="Delete Product" class="tip btn btn-danger btn-xs delete" data-id="<?php echo $value->id; ?>"><i class="feather-trash"></i></a></div></td>
