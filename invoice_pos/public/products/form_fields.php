       ...
       <div class="row">
          <div class="col-md-6">
             ...
             <div class="form-group">
                ...
                <input type="text" name="pname" value="<?php echo h($product->pname); ?>" class="form-control form-control-sm tip" id="name" required="required" />
             </div>
             <div class="form-group d-none">
                ...
                <input type="text" name="code" readonly value="<?php echo h($product->code); ?>" class="form-control form-control-sm tip" id="code" required />
             </div>
             <div class="form-group d-none">
             ...
             <div class="row">
                <div class="form-group col-md-6">
                   ...
                   <input type="text" name="cost" value="<?php echo h($product->cost); ?>" class="form-control form-control-sm tip" id="cost" />
                </div>
                <div class="form-group col-md-6">
                   <label for="price">Selling Price: </label>
                   <input type="text" name="price" value="<?php echo h($product->price); ?>" class="form-control form-control-sm tip" id="price" required="required" />
             ...
             <div class="row shut_wrap d-none">
                <div class="form-group col-md-6">
                   ...
                   <input type="text" name="shut_price" value="<?php echo h($product->shut_price); ?>" class="form-control form-control-sm tip" id="shut_price" />
                </div>

                <div class="form-group col-md-6">
                   <label for="price">No. of Shot in bottle</label>
                   <input type="text" name="no_of_shut" value="<?php echo h($product->no_of_shut); ?>" class="form-control form-control-sm tip" id="no_shut" />
          ...
          <div class="col-md-6">
                ...
                <div class="well well-sm">
                   ...
                   <div class="row">
                      <div class="form-group col-md-6">
                         ...
                         <input type="text" name="quantity" value="<?php echo h($product->quantity); ?>" class="form-control form-control-sm tip" id="quantity1" />
                      </div>
                      <div class="form-group col-md-6">
                         <label for="alert_quantity">Alert Quantity</label>
                         <input type="text" name="alert_quantity" value="<?php echo h($product->alert_quantity); ?>" class="form-control form-control-sm tip" id="alert_quantity" required="required" />
                      </div>
                      <div class="form-group col-md-6" style="margin-bottom:0;">
                         <input type="hidden" name="left_bottle" value="<?php echo h($product->left_bottle); ?>" class="form-control form-control-sm tip" id="left_bottle" />

                         <input type="hidden" name="left_shut" id="left_shut" class="form-control form-control-sm tip" value="<?php echo h($product->left_shut); ?>">
                      </div>
                   </div>
                </div>
             </div>
             ...
             <div class="form-group">
                ...
                <input type="file" class="form-control form-control-sm" value="<?php echo h($product->file); ?>" name="file[]" multiple id="image">
             </div>
             <div class="row">
                <div class="form-group col-md-6">
                   <label for="product_tax">Product Tax</label>
                   <input value="7.5" type="text" name="product_tax" value="<?php echo h($product->product_tax); ?>" class="form-control form-control-sm tip" id="product_tax" required="required" />
