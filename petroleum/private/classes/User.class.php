...
class User extends DatabaseObject
{
    ...
    protected static $db_columns = ['id', 'full_name', 'email', 'phone', 'profile_img', 'address', 'hashed_password', 'reset_password', 'admin_level', 'company_id', 'branch_id', 'created_at', 'updated_at', 'created_by', 'deleted'];
    ...
    protected function validate()
    {
        ...
        if (is_blank($this->admin_level)) {
            $this->errors[] = "Admin level cannot be blank.";
        }
