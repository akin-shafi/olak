...
class AccessControl extends DatabaseObject
{
  ...
  protected static $db_columns = ['id', 'user_id', 'dashboard', 'sales_mgt', 'add_dip', 'add_sales', 'edit_sales', 'manage_sales', 'expenses_mgt', 'add_exp', 'edit_exp', 'delete_exp', 'report_mgt', 'access_control', 'company_setup', 'user_mgt', 'product_mgt', 'filtering', 'created_by', 'created_at', 'deleted'];
  ...
  const PERMISSION = ['dashboard', 'sales_mgt', 'add_dip', 'add_sales', 'edit_sales', 'manage_sales', 'expenses_mgt', 'add_exp', 'edit_exp', 'delete_exp', 'report_mgt', 'access_control', 'company_setup', 'user_mgt', 'product_mgt', 'filtering',];
