   ...
   <header class="header">
      <div class="logo-wrapper">
         <a href="<?php echo url_for('/dashboard') ?>" class="logo text-white">
            <img src="<?php echo url_for('/olak.png') ?>" alt="Olak Pet" />
            Olak Pet.
         </a>
      </div>

      <div class="header-items">
         <div class="custom-search d-none">
         ...
         <div class="collapse navbar-collapse" id="WafiAdminNavbar">
            <ul class="navbar-nav">
               ...
               <?php if ($access->sales_mgt == 1) : ?>
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle <?php echo $page == 'Sales' ? 'active-page' : '' ?>" href="#" id="salesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
