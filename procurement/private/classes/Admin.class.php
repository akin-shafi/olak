...
class Admin extends DatabaseObject
{
    ...
    protected static $db_columns = ['id', 'full_name', 'email', 'phone', 'profile_img', 'address', 'hashed_password', 'reset_password', 'admin_level', 'company_id', 'branch_id', 'status', 'created_by', 'created_at', 'updated_at', 'deleted'];
