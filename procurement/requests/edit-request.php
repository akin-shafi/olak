                          ...
                          <tbody>
                            <?php foreach ($requestDetails as $data) : ?>
                              <tr class="mtable">
                                ...
                                <td>
                                  <input type="number" name="quantity[]" value="<?php echo $data->quantity; ?>" class="form-control form-control-sm quantity qty" id="qty_<?php echo $data->id; ?>" placeholder="eg. 5" required>
                                </td>
                                <td>
                                  <input type="number" name="unit_price[]" value="<?php echo $data->unit_price; ?>" class="form-control form-control-sm unit_price" id="price_<?php echo $data->id; ?>" placeholder="eg. 120" <?php echo $isRequester ? 'readonly' : '' ?>>
                                </td>
                                <td>
