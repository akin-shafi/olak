 <a href="#top" id="back-to-top" style="display: inline;"><span class="feather feather-chevrons-up"></span></a>
   ...
   <footer class="footer">
      <div class="container">
         <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 mt-3 mt-lg-0 text-center"> Copyright © 2021 <a href="#">Dayone</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="#">Spruko Technologies Pvt.Ltd</a> All rights reserved. </div>
         </div>
      </div>
   </footer>
   <!-- End Footer--> <!--sidebar-right--> 
   <div class="sidebar sidebar-right sidebar-animate ps ps--active-y">
      <div class="card-header border-bottom pb-5">
         <h4 class="card-title">Notifications </h4>
         <div class="card-options"> <a href="#" class="btn btn-sm btn-icon btn-light text-primary" data-bs-toggle="sidebar-right" data-bs-target=".sidebar-right"><i class="feather feather-x"></i> </a> </div>
      </div>
      <div class="">
         ...
         <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
               ...
               <div class="mt-1"> <a href="#" class="font-weight-semibold fs-16">James<span class="text-muted font-weight-normal"> Order Placed</span></a> <span class="clearfix"></span> <span class="text-muted fs-13 ms-auto"><i class="mdi mdi-clock text-muted me-1"></i>1 day ago</span> </div>
               <div class="ms-auto">
                  <a href="" class="me-0 option-dots" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <span class="feather feather-more-horizontal"></span> </a> 
                  <ul class="dropdown-menu dropdown-menu-end" role="menu">
                     <li><a href="#"><i class="feather feather-eye me-2"></i>View</a></li>
         ...
         <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
               ...
               <div class="mt-1"> <a href="#" class="font-weight-semibold fs-16">Mack<span class="text-muted font-weight-normal"> your admin lanuched</span></a> <span class="clearfix"></span> <span class="text-muted fs-13 ms-auto"><i class="mdi mdi-clock text-muted me-1"></i>1 week ago</span> </div>
               <div class="ms-auto">
                  <a href="" class="me-0 option-dots" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <span class="feather feather-more-horizontal"></span> </a> 
                  <ul class="dropdown-menu dropdown-menu-end" role="menu">
                     <li><a href="#"><i class="feather feather-eye me-2"></i>View</a></li>
         ...
         <div class="list-group-item  align-items-center  border-bottom">
            <div class="d-flex">
               ...
               <div class="mt-1"> <a href="#" class="font-weight-semibold fs-16">Julia<span class="text-muted font-weight-normal"> Prepare for Presentation</span></a> <span class="clearfix"></span> <span class="text-muted fs-13 ms-auto"><i class="mdi mdi-clock text-muted me-1"></i>18 Nov 2020 11:55 Am</span> </div>
               <div class="ms-auto">
                  <a href="" class="me-0 option-dots" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <span class="feather feather-more-horizontal"></span> </a> 
                  <ul class="dropdown-menu dropdown-menu-end" role="menu">
                     <li><a href="#"><i class="feather feather-eye me-2"></i>View</a></li>
      ...
      <div class="ps__rail-y" style="top: 0px; height: 793px; right: 0px;">
         <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 620px;"></div>
      </div>
   </div>
   <!--/sidebar-right--> <!--Clock-IN Modal --> 
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="countdowntimer"><span id="clocktimer" class="border-0 style size_md" style="background: transparent; color: rgb(49, 62, 106); border-color: transparent;">23:37:48</span></div>
   ...
   <!-- End Clock-IN Modal  --> <!--Change password Modal --> 
...
<script src="<?php echo url_for('assets/plugins/sidemenu/sidemenu.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/p-scrollbar/p-scrollbar.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/p-scrollbar/p-scroll1.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/sidebar/sidebar.js') ?>"></script>

<script src="<?php echo url_for('assets/plugins/peitychart/jquery.peity.min.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/peitychart/peitychart.init.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/apexchart/apexcharts.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/vertical-scroll/jquery.bootstrap.newsbox.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/vertical-scroll/vertical-scroll.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/date-picker/jquery-ui.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/chart/chart.bundle.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/chart/utils.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/time-picker/jquery.timepicker.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/time-picker/toggles.min.js') ?>"></script>
...
<script src="<?php echo url_for('assets/plugins/datatable/js/dataTables.bootstrap5.js') ?>"></script>
<script src="<?php echo url_for('assets/plugins/datatable/js/dataTables.buttons.min.js') ?>"></script>
