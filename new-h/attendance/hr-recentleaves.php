            ...
            <div class="row">
               ...
               <div class="col-xl-3 col-lg-6 col-md-12">
                  <div class="card border p-0 shadow-none">
                     <div class="card-header border-0">
                        <h3 class="card-title">Earned Leave Request</h3>
                        <div class="ms-auto"> <span class="badge badge-md badge-warning-light">2 days left</span> </div>
                     </div>
                     <div class="d-flex p-4">
                        <div>
                           <div class="avatar avatar-lg brround d-block cover-image" data-image-src="../../assets/images/users/3.jpg" style="background: url(&quot;../../assets/images/users/3.jpg&quot;) center center;"></div>
                        </div>
                        <div class="ps-3">
                     ...
                     <div class="card-body pt-2 bg-light">
                        <div class="mt-3 mb-3">
                           <div class="h5 mb-1"> <span class="feather feather-calendar"></span> : 22-01-2021 <span class="badge badge-md badge-primary-light ms-1">1 day</span> </div>
               ...
               <div class="col-xl-3 col-lg-6 col-md-12">
                  <div class="card border p-0 shadow-none">
                     <div class="card-header border-0">
                        <h3 class="card-title">Earned Leave Request</h3>
                        <div class="ms-auto"> <span class="badge badge-md badge-warning-light">8 days left</span> </div>
                     </div>
                     <div class="d-flex p-4">
                        <div>
                           <div class="avatar avatar-lg brround d-block cover-image" data-image-src="../../assets/images/users/11.jpg" style="background: url(&quot;../../assets/images/users/11.jpg&quot;) center center;"></div>
                        </div>
                        <div class="ps-3">
                     ...
                     <div class="card-body pt-2 bg-light">
                        <div class="mt-3 mb-3">
                           <div class="h5 mb-1"> <span class="feather feather-calendar"></span> : 18-01-2021<span class="text-muted leave-to">To</span>19-01-2021 <span class="badge badge-md badge-primary-light ms-1">2 days</span> </div>
               ...
               <div class="col-xl-3 col-lg-6 col-md-12">
                  <div class="card border p-0 shadow-none">
                     <div class="card-header border-0">
                        <h3 class="card-title">Earned Leave Request</h3>
                        <div class="ms-auto"> <span class="badge badge-md badge-warning-light">Today</span> </div>
                     </div>
                     <div class="d-flex p-4">
                        <div>
                           <div class="avatar avatar-lg brround d-block cover-image" data-image-src="../../assets/images/users/4.jpg" style="background: url(&quot;../../assets/images/users/4.jpg&quot;) center center;"></div>
                        </div>
                        <div class="ps-3">
                     ...
                     <div class="card-body pt-2 bg-light">
                        <div class="mt-3 mb-3">
                           <div class="h5 mb-1"> <span class="feather feather-calendar"></span> : 11-01-2021 <span class="badge badge-md badge-primary-light ms-1">Half day</span> </div>
               ...
               <div class="col-xl-3 col-lg-6 col-md-12">
                  <div class="card border p-0 shadow-none">
                     ...
                     <div class="d-flex p-4">
                        <div>
                           <div class="avatar avatar-lg brround d-block cover-image" data-image-src="../../assets/images/users/12.jpg" style="background: url(&quot;../../assets/images/users/12.jpg&quot;) center center;"></div>
                        </div>
                        <div class="ps-3">
                     ...
                     <div class="card-body pt-2 bg-light">
                        <div class="mt-3 mb-3">
                           <div class="h5 mb-1"> <span class="feather feather-calendar"></span> : 09-01-2021 <span class="badge badge-md badge-primary-light ms-1">1 day</span> </div>
