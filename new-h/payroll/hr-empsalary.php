                           ...
                           <tbody>
                              ...
                              ?>
                                 <tr>
                                    ...
                                    <td class="text-start"> 
                                       <a href="#" class="action-btns viewSalary" data-id="<?php echo $value->id ?>"> <i class="feather feather-eye text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="View Salary Details" aria-label="View"></i> </a> 
