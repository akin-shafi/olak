...
$tax = Payroll::tax_calculator(['netSalary' => $employee->present_salary]);
                              ...
                              <tbody>
			                    ...
			                    <?php if ($value->addon == 0) : ?>
                                 ...
                                 <tr class="border-top">
                                    ...
                                    <td class="font-weight-semibold border-start" id="value_of_return"></td>
                                 </tr>
                              </tbody>
                           </table>
                        </div>
               ...
               <table class="table mb-0">
                  <tbody>
                     <tr>
                        ...
                        <td class="pb-0 pt-0">
                           <h4 class="font-weight-semibold mb-0 fs-24"><?php echo $currency ?> </h4>
                        </td>
                     </tr>
                     <tr>
