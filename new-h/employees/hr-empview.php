                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-9"> <textarea name="personal[permanent_add]" rows="3" class="form-control" placeholder="Address2"><?php echo trim($employee->permanent_add) ?? '' ?></textarea> </div>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="row">
