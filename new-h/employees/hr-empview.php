...
$id = $_GET['id'] ?? 1;
$employee = EmployeeData::find_by_employee_data($id);
?>
                  ...
                  <div class="card-body">
                     ...
                     <div class="form-group ">
                        <div class="row">
                           ...
                           <div class="col-md-9">
                              <div class="row">
                                 <div class="col-md-4"> <input type="text" name="personal[firstname]" value="<?php echo $employee->firstname ?>" class="form-control mb-md-0 mb-5" placeholder="First Name"> <span class="text-muted"></span> </div>
                                 <div class="col-md-4"> <input type="text" name="personal[lastname]" value="<?php echo $employee->lastname ?>" class="form-control" placeholder="Last Name"> </div>
                                 <div class="col-md-4"> <input type="text" name="personal[othername]" value="<?php echo $employee->othername ?>" class="form-control" placeholder="Middle Name"> </div>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-9"> <input type="tel" name="personal[phone]" value="<?php echo $employee->phone ?>" class="form-control" placeholder="Phone Number"> </div>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="row">
                           <div class="col-md-3"> <label class="form-label mb-0 mt-2">Next of Kin Name</label> </div>
                           <div class="col-md-9"> <input type="tel" name="personal[kin_name]" value="<?php echo $employee->kin_name ?>" class="form-control" placeholder="Next of Kin Name"> </div>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="row">
                           <div class="col-md-3"> <label class="form-label mb-0 mt-2">Next of Kin Number</label> </div>
                           <div class="col-md-9"> <input type="tel" name="personal[kin_phone]" value="<?php echo $employee->kin_phone ?>" class="form-control" placeholder="Contact Number"> </div>
                        </div>
                     </div>
                     <div class="form-group ">
                        <div class="row">
                           <div class="col-md-3"> <label class="form-label mb-0 mt-2">Date Of Birth</label> </div>
                           <div class="col-md-9"> <input type="date" name="personal[dob]" value="<?php echo $employee->dob ?>" class="form-control fc-datepicker hasDatepicker" placeholder="DD-MM-YYY" id="dp1642289966077"> </div>
                        </div>
                     </div>
                     <div class="form-group ">
                        <div class="row">
                           ...
                           <div class="col-md-9">
                              <div class="custom-controls-stacked d-md-flex"> <label class="custom-control custom-radio me-4"> <input type="radio" class="custom-control-input" name="personal[gender]" <?php echo $employee->gender == 'male' ? 'checked' : '' ?> value="male"> <span class="custom-control-label">Male</span> </label> <label class="custom-control custom-radio"> <input type="radio" class="custom-control-input" name="personal[gender]" <?php echo $employee->gender == 'female' ? 'checked' : '' ?> value="female"> <span class="custom-control-label">Female</span> </label> </div>
                           </div>
                        </div>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-9"> <textarea name="personal[present_add]" rows="3" class="form-control" placeholder="Address1">
                              <?php echo trim($employee->present_add) ?? '' ?>
                           </textarea> </div>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-9"> <textarea name="personal[permanent_add]" rows="3" class="form-control" placeholder="Address2">
                              <?php echo trim($employee->permanent_add) ?? '' ?>
                           </textarea> </div>
                        </div>
                     </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-9"> <input type="email" name="personal[email]" value="<?php echo $employee->email ?>" class="form-control" placeholder="employee email"> </div>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="row">
                     ...
                     <div class="form-group mt-7">
                        <div class="row">
                           ...
                           <div class="col-md-9"> <label class="custom-switch"> <input type="checkbox" name="personal[notification]" <?php echo $employee->notification == 'on' ? 'checked' : '' ?> class="custom-switch-input"> <span class="custom-switch-indicator"></span> <span class="custom-switch-description">On/Off</span> </label> </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="card-body">
                           ...
                           <div class="col-md-9">
                              <select name="company[employee_id]" class="form-control custom-select select2 select2-hidden-accessible" data-placeholder="Select Employee" required>
                                 ...
                                 <?php foreach (EmployeeData::find_by_undeleted() as $value) : ?>
                                    <option value="<?php echo $value->id ?>" <?php echo $employee->id == $value->id ? 'selected' : '' ?>><?php echo ucwords($value->full_name()) ?></option>
                                 <?php endforeach; ?>
                              </select>
                           </div>
                        </div>
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-9"> <input type="text" name="company[employee_number]" value="<?php echo $employee->employee_number ?? '' ?>" class="form-control" placeholder="#ID"> </div>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="row">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-9"> <input type="text" name="company[location]" value="<?php echo $employee->location ?>" class="form-control" placeholder="Location"> </div>
                        </div>
                     </div>
                     <div class="form-group">
                        <div class="row">
