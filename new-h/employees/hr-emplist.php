                              ...
                              <table class="table table-vcenter text-nowrap table-bordered border-bottom dataTable no-footer" id="hr-table" role="grid" aria-describedby="hr-table_info">
                                 <thead>
                                    <tr role="row">
                                       ...
                                       <th class="border-bottom-0 sorting" tabindex="0" aria-controls="hr-table" rowspan="1" colspan="1" aria-label="Designation: activate to sort column ascending" style="width: 113.663px;">Designation</th>
                                 ...
                                 <tbody>
                                    ...
                                    <tr class="<?php echo $class; ?>">
                                       ...
                                       <td><?php echo Department::find_by_id($value->department_id)->department_name; ?></td>
                                       <td>Web Designer</td>
                                       <td>+9685321475</td>
                                       <td>05-05-2017</td>
                                       <td> 
                     ...
                     <?php 
                        ...
                        <tr>
                           ...
                           <td class="p-2">
                              ...
                              <span class="ms-auto font-weight-semibold fs-16 staff_strength"><?php echo count($employee); ?></span></td>
                        </tr>
                       <?php } ?>
