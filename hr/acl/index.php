    ...
    <div class="page-rightheader ms-md-auto">
        <div class="d-flex align-items-end flex-wrap my-auto end-content breadcrumb-end">
            <div class="btn-list">
                ...
                <a href="<?php echo url_for('public/users/exportData.php') ?>" class="btn btn-success d-none"> <i
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="basic-datatable"
                        class="table table-sm table-hover table-striped dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>s/n.</th>
                                <th>Full Name</th>
                    ...
                    foreach ($expBranch as $exBra) :
                      $branch = ucwords(Branch::find_by_id($exBra)->branch_name);  ?>
                                ...
                                <td style="min-width: 150px;">
                                    ...
                                    <button data-id="<?php echo $value->id ?>"
                                        class="btn btn-outline-danger btn-sm deleted">Delete</button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
            ...
            <div class="modal-body">
                ...
                <form class="ps-3 pe-3 row" id="acl_form">
                    ...
                    <div class="mb-3 col-md-12">
                        ...
                        <select class="select2 form-control company" name="company_id[]" id="company_id"
