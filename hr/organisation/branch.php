       ...
       <div class="page-header">
          <div class="row align-items-center">
             ...
             <div class="col-auto float-end ms-auto">
                <a href="#" class="btn add-btn" data-bs-toggle="modal" data-bs-target="#add_branch"><i class="fa fa-plus"></i> Add branch</a>
                <div class="view-icons">
                  <!-- <a href="<?php //echo url_for('Branches/') ?>" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a> -->
          ...
          <div class="col-md-12">
             <div class="table-responsive">
                  <table class="datatable table table-stripped mb-0">
                   ...
                   <tbody>
                     <?php $sn =1; foreach (Branch::find_by_undeleted(['order' => 'ASC']) as $key => $value) { 
                        // pre_r($value);
                     ?>
                      <tr>
                        <!-- <td><?php //echo $sn++ ?></td> -->
                         <td>
                            <h2 class="table-avatar">
                               <a href="profile.php" class="avatar"><img alt="" src="assets/img/profiles/<?php echo $value->logo ?>"></a>
                               <a href="profile.php"><?php echo $value->branch_name ?> </a>
                            </h2>
                         </td>
                   ...
                   <div class="row">
                     <div class="col-sm-6">
                         <div class="form-group">
                            <label class="col-form-label">Comapny <span class="text-danger">*</span></label>
                            <!-- <input class="form-control" name="branch_name" type="text"> -->
                            <select class="form-control"  name="compaqny_id">
                      ...
                      <div class="col-sm-6">
                         <div class="form-group">
                            ...
                            <input class="form-control" name="established_in" type="text">
                         </div>
                      </div>
