          ...
          <div class="row align-items-center">
             ...
             <div class="col-auto float-end ms-auto">
                ...
                <div class="view-icons">
                  <!-- <a href="<?php //echo url_for('companies/') ?>" class="grid-view btn btn-link active"><i class="fa fa-th"></i></a> -->
          ...
          <div class="col-md-12">
             <div class="table-responsive">
                  <table class="datatable table table-stripped mb-0">
                   ...
                   <tbody>
                     <?php $sn =1; foreach (Company::find_by_undeleted(['order' => 'ASC']) as $key => $value) { 
                        // pre_r($value);
                     ?>
                      <tr>
                        <!-- <td><?php //echo $sn++ ?></td> -->
                         <td>
                            <h2 class="table-avatar">
                               ...
                               <a href="profile.php"><?php echo $value->company_name ?> </a>
                            </h2>
                         </td>
                   ...
                   <div class="row">
                      ...
                      <div class="col-sm-6">
                         <div class="form-group">
                            ...
                            <input class="form-control" name="registration_no" type="text">
                         </div>
                      </div>
