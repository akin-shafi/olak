 ...
 <div class="content-wrapper">
       <section class="content">
           <div class="container">
               <div class="row">
                   <div class="col-md-12">
                       <h2 class="mb-25">Purchases by Vendor <a href="#" class="btn btn-default btn-rounded print pull-right"><i class="fa fa-print"></i> Print </a></h2>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12 scroll table-responsive mt-50 p-0 print_area">
                 <table class="table table-hover">
                     <thead class="bg-light">
                         <tr>
                             <th>Customers</th>
                             <th class="text-right">All Purchase</th>
                             <th class="text-right">Paid Purchase</th>
                         </tr>
                     </thead>
